...
**Problem:** ask a single AI agent to investigate a bug or figure out how something works, and it will drift — find threads, follow them, arrive at plausible-looking explanations that may or may not address what you actually asked.

**Solution:** Dream Team splits the work across three agents in a tug-of-war dynamic:
